...
//     RTSMB_PACK_WORD (rtsmb_util_get_spnego_blob_size()); // Blob length
     spnego_blob_size = rtsmb_util_get_spnego_other_blob(&spnego_blob);
  ...
  {
//    spnego_blob_size = rtsmb_util_get_spnego_other_blob(&spnego_blob);
//    RTSMB_PACK_ITEM (spnego_blob, spnego_blob_size);
    spnego_blob_size=encode_spnego_ntlm2_type2_response_packet(spnego_blob, spnego_blob_size);
    RTSMB_PACK_ITEM (spnego_blob, spnego_blob_size);
