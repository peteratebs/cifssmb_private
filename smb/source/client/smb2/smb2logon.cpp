...
//      return Smb2NBSSCmd.status;
  ...
  //    int send_status;
    ...
    pSmb2Session->ReplyBuffer.pull_input(pSmb2Session->ReplyBuffer.peek_input(),InNbssHeader.FixedStructureSize()+InSmb2Header.FixedStructureSize()+Smb2SetupReply.FixedStructureSize() ,bytes_pulled);
...
//    int send_status;
  ...
  // Pull
  dword bytes_pulled;
  pSmb2Session->ReplyBuffer.pull_input(pSmb2Session->ReplyBuffer.peek_input(),InNbssHeader.FixedStructureSize()+InSmb2Header.FixedStructureSize()+Smb2NegotiateReply.FixedStructureSize() ,bytes_pulled);
...
{
    int send_status;
    SendBuffer.stream_buffer_mid = 0;
    NetNbssHeader       OutNbssHeader;
    NetSmb2Header       OutSmb2Header;
    NetSmb2SetupCmd     Smb2SetupCmd;
